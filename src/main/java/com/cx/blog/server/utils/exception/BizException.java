...
public class BizException extends Exception {
    ...
    public BizException(ExceptionCodes exceptionCodes) {
        super(exceptionCodes.getMsg());
        this.code = exceptionCodes.getCode();
        this.localizedMessage = exceptionCodes.getMsg();
    }

    public BizException(ExceptionCodes exceptionCodes, Throwable cause) {
        super(cause.getMessage(), cause);
        this.code = exceptionCodes.getCode();
        this.localizedMessage = exceptionCodes.getMsg();
    }

    public BizException(ExceptionCodes exceptionCodes, Object... replacements) {
    ...
    public BizException(ExceptionCodes exceptionCodes, Throwable cause, Object... replacements) {
        super(cause.getMessage(), cause);
        this.code = exceptionCodes.getCode();
        this.localizedMessage = MessageFormat.format(exceptionCodes.getMsg(), replacements);
    }
